...
export const StudentForm = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    scheduledMonday: student?.scheduledMonday !== false, // Default to true
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-5 gap-3">
              {[
                { day: 'Monday', field: 'scheduledMonday' },
                { day: 'Tuesday', field: 'scheduledTuesday' },
                { day: 'Wednesday', field: 'scheduledWednesday' },
                { day: 'Thursday', field: 'scheduledThursday' },
                { day: 'Friday', field: 'scheduledFriday' }
              ].map(({ day, field }) => (
                <label key={field} className="flex flex-col items-center space-y-1 p-2 border border-gray-200 rounded-md hover:bg-gray-50">
